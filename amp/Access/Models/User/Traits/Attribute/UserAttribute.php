...
namespace Amp\Access\Models\User\Traits\Attribute;
...
trait UserAttribute
{
    ...
    {
        return config('wbp.access.users.change_email');
    }
    ...
    {
        return ! app('session')->has(config('wbp.access.socialite_session_name'));
    }
